#' gps_smoothing_spline: a class useful for smoothing noisy gps data and removing
#' outliers.
#'
#' @return
#'
...
#                 } else if (strcmp(varargin{k}, 'lon0')){
#                     lon0 <- varargin{k+1}
#                 } else if (strcmp(varargin{k}, 'x0')){
#                     x0 <- varargin{k+1}
#                 } else if (strcmp(varargin{k}, 'y0')){
#                     y0 <- varargin{k+1}
#                 }
#             }
#
