...
The class is the basis of the other classes.
...
gg_splines <- ggplot(splines_values, aes(y = value, x = tq)) +
  geom_line(aes(colour = order), size = 1.2, show.legend = FALSE) +
...
<img src="man/figures/README-plot-bspline-1.png" width="100%" />
